...
def download_pack(widget=None):
    ...
    pack_json = requests.get(
        "https://api.github.com/repos/Fabulously-Optimized/fabulously-optimized/releases/latest"
    ).json()
    pack_file = ""
    ...
    text_update(
        f'Downloading Pack ({int(download.headers["Content-Length"])//1000} KB)...',
        widget,
    )
